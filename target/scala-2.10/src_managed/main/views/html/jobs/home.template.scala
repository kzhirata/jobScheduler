...
"""))}
    ...
    def render(message:String,jobs:List[Job],searchForm:Form[String]): play.api.templates.Html = apply(message,jobs,searchForm)
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/hiratak_work/Desktop/a/eclipse/Eclipse.app/Contents/MacOS/workspace/jobScheduler/app/views/jobs/home.scala.html

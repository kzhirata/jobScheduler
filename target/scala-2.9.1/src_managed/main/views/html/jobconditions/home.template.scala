...
"""))}
    ...
    def render(message:String,jobconditions:List[JobCondition],searchForm:Form[String]) = apply(message,jobconditions,searchForm)
    ...
    def ref = this
                ...
                /*
                    ...
                    SOURCE: /Users/hiratak_work/Documents/workspace/jobScheduler/app/views/jobconditions/home.scala.html
